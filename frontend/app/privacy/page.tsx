  ...
  return (
    <main className="min-h-screen bg-background px-6 py-16 sm:px-8">
      <article className="mx-auto max-w-3xl">
        ...
        <h1 className="mt-2 font-serif text-4xl text-foreground sm:text-5xl">Privacy Policy</h1>
        ...
        <div className="mt-10 space-y-8 text-sm leading-7 text-foreground/90">
          <section>
            <h2 className="font-serif text-2xl text-foreground">1. Data We Collect</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-serif text-2xl text-foreground">2. What We Do Not Collect</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-serif text-2xl text-foreground">3. Mention Data</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-serif text-2xl text-foreground">4. How We Use Data</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-serif text-2xl text-foreground">5. Third-Party Services</h2>
            <p className="mt-3">
